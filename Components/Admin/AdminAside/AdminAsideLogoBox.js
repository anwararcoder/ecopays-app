...
const AdminAsideLogoBox = ({ openAside, setOpenAside }) => {
  return (
    <div className="flex flex-wrap items-center justify-between gap-[15px] p-[25px]">
    <Image className="max-w-[120px]" src={LogoImage} alt="LogoImage" />
    <button
      className="lg:hidden w-[40px] h-[40px] bg-[#133b6e] flex items-center justify-center rounded-[3px] hover:bg-[#3498db]"
...
export default AdminAsideLogoBox
