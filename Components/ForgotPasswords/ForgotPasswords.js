...
import { forgotPasswords, loginUser } from "@/ReactQuery/FunctionsReactQuery";
...
const ForgotPasswords = () => {
    ...
    const useForgotPasswordsMutation = () => {
        return useMutation({
            mutationFn: forgotPasswords,
            onSuccess: (response, variables) => {
                storage.set("VerifyResetCodeState", variables.email);
    ...
    const { mutateAsync, isPending } = useForgotPasswordsMutation();
